...
class relatorio_cnpj extends JFrame implements ActionListener{
	...
	public static void main (String[] args) {
		JFrame adicionar = new relatorio_cnpj();	
	...
	relatorio_cnpj(){
		iniciaTabela();
        conecta.conexao();
       	preencherTabela("SELECT * FROM cadastrocnpj ORDER BY Cod ");
        
		setTitle("Relatório CNPJ");
		...
		c.add(jTable1);
            ...
            btCNPJ = new JButton();
  			btCNPJ.setText("CNPJ");
           	btCNPJ.setBounds(346,30,100,30);
           	btCNPJ.setSize(120,20);
            ...
            btIns = new JButton();
  			btIns.setText("Inscrição Estadual");
           	btIns.setBounds(465,30,100,30);
           	btIns.setSize(133,20);
    ...
    private void iniciaTabela() {
	 ...
	 public void preencherTabela(String SQL){
        ...
        String[] Colunas = new String[]{"Cod","Nome","CNPJ","Ins","EmailP","TelF","Cidade"};
